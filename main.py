...
fgcolor = "white"
root['bg'] = "#050513" #transparentcolor reference
root.overrideredirect(1)

#root.title("Centered!") 
root.attributes("-topmost", True)
root.attributes("-transparentcolor", "#050513")
...
image_label = tk.Label(root, image = barimg, bg='#050513')
image_label.pack()
...
def show_hide(*args):
    ...
    if top_enabled != True: #hide
        ...
        root.geometry(f"{414}x{1}+{x}+{0}") #set height(currently 1) preferrably between 1-5
        top_enabled = True
